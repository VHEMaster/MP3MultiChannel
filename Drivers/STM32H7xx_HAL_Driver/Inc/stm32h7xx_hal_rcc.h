...
#define HSE_TIMEOUT_VALUE          (HSE_STARTUP_TIMEOUT * 10)
#define HSI_TIMEOUT_VALUE          (20U)    /* 2 ms */
#define HSI48_TIMEOUT_VALUE        (20U)    /* 2 ms */
#define CSI_TIMEOUT_VALUE          (20U)    /* 2 ms */
#define LSI_TIMEOUT_VALUE          (20U)    /* 2 ms */
#define PLL_TIMEOUT_VALUE          (20U)    /* 2 ms */
#define CLOCKSWITCH_TIMEOUT_VALUE  (50000U) /* 5 s  */
#define RCC_DBP_TIMEOUT_VALUE      (1000U)
#define RCC_LSE_TIMEOUT_VALUE      (LSE_STARTUP_TIMEOUT * 10)
