...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLL2.PLL2P = 31;
...
static void MX_SAI2_Init(void)
{
  ...
  hsai_BlockA2.SlotInit.FirstBitOffset = 1;
  hsai_BlockA2.SlotInit.SlotSize = SAI_SLOTSIZE_DATASIZE;
  hsai_BlockA2.SlotInit.SlotNumber = 16;
  ...
  hsai_BlockB2.SlotInit.SlotNumber = 16;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LED1_GREEN_Pin|LED2_YELLOW_Pin|LED3_RED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED1_GREEN_Pin LED2_YELLOW_Pin LED3_RED_Pin */
  GPIO_InitStruct.Pin = LED1_GREEN_Pin|LED2_YELLOW_Pin|LED3_RED_Pin;
